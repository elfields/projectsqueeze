...
export const CarouselItem = ({children, width}) => {
    ...
    return (
        <div className='podcast-carousel-item'> 
            {children}
        </div>
    );
...
const PodcastCarouselCard = ({podcastid, podcastimage, podcasttitle, podcastauthor, podcastdescription}) => {
            ...
            <CarouselItem>
                    <div className = "podcast-card-body">
                        ...
                        <div className='podcast-card-content'>
                            ...
                            <div className='podcast-card-title'>{ podcasttitle }</div>
                            <div className='podcast-card-subtitle'>{ podcastauthor }</div>

                            <div className = "podcast-card-text">
                                <p className = "podcast-card-text" 
                        ...
                        <div>
                        <Link to={`/listen/${podcastid}`}>
                            <button className="card-listen-button" variant="primary">Listen</button>
                        </Link>
                        <Link to='/user'>
                            <button className="card-follow-button" variant="secondary">Follow</button>
                        </Link>
                        </div>
                    </div>
            </CarouselItem>        
...
export default PodcastCarouselCard;
